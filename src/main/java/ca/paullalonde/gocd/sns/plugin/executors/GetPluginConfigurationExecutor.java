...
import ca.paullalonde.gocd.sns.plugin.utils.Field;
import ca.paullalonde.gocd.sns.plugin.utils.NonBlankField;
...
public class GetPluginConfigurationExecutor implements RequestExecutor {
    ...
    public static final Field REGION = new NonBlankField("region", "Region", "us-east-1", true, false, "0");
    public static final Field TOPIC = new NonBlankField("topic", "Topic ARN", null, true, false, "1");
